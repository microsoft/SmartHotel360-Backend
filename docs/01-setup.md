...
1. Once the command completes, execute the command below to see all of the ingresses in the AKS cluster. 
    ...
    One of the ingresses has the suffix **sh360-web** - that's the public web site ingress (the prefix is dynamically generated by Kubernetes). 

1. Copy the IP address from the terminal window and enter it into a browser and the public site should appear. 
